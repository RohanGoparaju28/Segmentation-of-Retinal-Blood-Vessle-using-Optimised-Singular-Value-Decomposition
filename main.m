close all; clc; clear;
im_rgb = im2double(imread('/MATLAB Drive/Major project/Drive/Test/images/02_test.tif'));
...
g_truth = imread('/MATLAB Drive/Major project/Drive/Test/1st_manual/05_manual1.gif');
